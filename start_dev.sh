...
cd ./docker
docker-compose -f docker-compose.dev.yml --project-name=mevn_books up --build -d rabbitmq
docker-compose -f docker-compose.dev.yml --project-name=mevn_books up --build -d mongodb-books mongodb-users mongodb-preferences
docker-compose -f docker-compose.dev.yml --project-name=mevn_books up --build -d books users preferences notifications gateway
