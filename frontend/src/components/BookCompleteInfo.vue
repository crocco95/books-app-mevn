    ...
    <div class="row book">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4 col-sm-6 text-md-start">
                    ...
                    <ul class="authors-list">
                        <li v-for="author in volumeInfo.authors">
                            <router-link :to='`/search?query=author:"${encodeURIComponent(author)}"`'>{{ author }}</router-link>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row my-3">
                ...
                <div class="col-md-6" v-if='canUserSeeReviewButtonFlag'>
...
export default {
    ...
    data() {
        return {
            ...
            canUserSeeReviewButtonFlag: false,
        }
    },
    ...
    methods: {
        ...
        canUserSeeReviewButton(){
            ...
            this.canUserSeeReviewButtonFlag = !foundFlag;
        }
    },
